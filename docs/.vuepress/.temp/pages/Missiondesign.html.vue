...
<h3 id="_2-3-1-electric-power-system" tabindex="-1"><a class="header-anchor" href="#_2-3-1-electric-power-system"><span>2.3.1 Electric Power System</span></a></h3>
  <br>
<p>The EPS is crucial subsytem for the proper functioning of a CubeSat. It is responsible for collecting, storing, and distributing the electrical power needed by other systems on the satellite to operate effectively. The EPS is also responsible for monitoring the overall health of the satellite, and protecting it and its subsystems from the high levels of radiation in space.</p>
<p>Below we discuss about the most important of EPS:</p>
<ul>
<li>
<p>Power Sources: The primary source of power for a CubeSat’s EPS is energy collected
...
<li>
<p>Power Control and Distribution: The EPS is responsible for regulating and distributing the power collected and stored by the solar panels and batteries to other systems
...
<li>
<p>Monitoring and Protection: The EPS also plays an important role in monitoring the
